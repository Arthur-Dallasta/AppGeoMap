...
class _PropertyFormScreenState extends ConsumerState<PropertyFormScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final data = {
        ...
        'protected_area_ha': double.parse(
          _protectedArea.text.replaceAll(',', '.'),
        ),
      ...
      setState(
        () => _error = msg is String ? msg : 'Erro ao salvar propriedade.',
      );
    } catch (_) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.propertyId == null ? 'Nova Propriedade' : 'Editar Propriedade',
        ),
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _text(_municipality, 'Município', required: true),
                ),
