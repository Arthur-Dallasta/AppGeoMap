...
class SubcategoriesNotifier extends FamilyAsyncNotifier<List<Subcategory>, String> {
  ...
  Future<void> create(String categoryId, String name, String? description) async {
...
final subcategoriesProvider =
    AsyncNotifierProviderFamily<SubcategoriesNotifier, List<Subcategory>, String>(
